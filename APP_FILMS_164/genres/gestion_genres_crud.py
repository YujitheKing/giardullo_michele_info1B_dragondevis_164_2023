        ...
        try:
            with DBconnection() as mc_afficher:
                if order_by == "ASC" and id_genre_sel == 0:
                    strsql_genres_afficher = """SELECT * FROM t_clients ORDER BY nom_clients ASC"""
                ...
                elif data_genres and id_genre_sel > 0:
                    flash(f"Le client est affiché", "success")
                else:
                    # Dans tous les autres cas, c'est que la table "t_genre" est vide.
                    # OM 2020.04.09 La ligne ci-dessous permet de donner un sentiment rassurant aux utilisateurs.
                    flash(f"Liste des clients affichée", "success")
    ...
    if request.method == "POST":
        try:
            if form.validate_on_submit():
                ...
                strsql_insert_genre = """INSERT INTO t_clients (id_clients,nom_clients) VALUES (NULL,%(value_intitule_genre)s) """
...
def genre_update_wtf():
    ...
    try:
        ...
        if request.method == "POST" and form_update.submit.data:
            ...
            str_sql_update_intitulegenre = """UPDATE t_clients SET nom_clients = %(value_name_genre)s 
            WHERE id_clients = %(value_id_genre)s """
            with DBconnection() as mconn_bd:
            ...
            str_sql_id_genre = "SELECT * FROM t_clients " \
                               "WHERE id_clients = %(value_id_genre)s"
            ...
            print("data_nom_genre ", data_nom_genre, " type ", type(data_nom_genre), " genre ",
                  data_nom_genre["nom_clients"])

            # Afficher la valeur sélectionnée dans les champs du formulaire "genre_update_wtf.html"
            form_update.nom_genre_update_wtf.data = data_nom_genre["nom_clients"]
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_del.data:
                ...
                valeur_delete_dictionnaire = {"id_clients": id_genre_delete}
                print("valeur_delete_dictionnaire ", valeur_delete_dictionnaire)

                str_sql_delete_films_genre = """DELETE FROM t_clients WHERE id_clients = %(id_clients)s"""
        ...
        if request.method == "GET":
            ...
            str_sql_genres_films_delete = """SELECT * 
                                            FROM t_clients c 
                                            INNER JOIN t_devis_avoir_clients dac ON c.id_clients = dac.fk_client
            ...
            with DBconnection() as mydb_conn:
                ...
                # Opération sur la BD pour récupérer "id_genre" et "intitule_genre" de la "t_genre"
                str_sql_id_genre = "SELECT id_clients,nom_clients FROM t_clients WHERE id_clients = %(value_id_genre)s"
            ...
            form_delete.nom_genre_delete_wtf.data = data_nom_genre["nom_clients"]

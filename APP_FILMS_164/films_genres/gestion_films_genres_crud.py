...
def edit_genre_film_selected():
    if request.method == "GET":
        try:
            ...
            lst_data_film_selected = [item['id_devis'] for item in data_genre_film_selected]
        ...
        try:
            ...
            with DBconnection() as mconn_bd:
                ...
                for id_genre_ins in lst_diff_genres_insert_a:
                    ...
                    valeurs_film_sel_genre_sel_dictionnaire = {"value_fk_devis": id_film_selected,
                                                               "value_fk_client": id_genre_ins}
